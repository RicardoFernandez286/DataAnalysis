function newmap = darkb2r(cmin_input,cmax_input,color_num,n_whites)
...
%   Updated:  Ricardo Fernández-Terán added "color_num" and "n_whites" to the input options (2018.05.29)
%  
%   Examples:
%   ------------------------------
%   figure
