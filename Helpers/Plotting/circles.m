function [h] = circles(ax,x,y,r,varargin)
...
%
% Updated by Ricardo Fernández-Terán, University of Zurich (2019.09.30)
% 
%% Syntax 
%  circles(x,y,r)
...
%% Description
% 
% circles(ax,x,y,r) plots circle(s) in axis ax, of radius(radii) r centered at points given by 
...
% Plot circles singly: 
for n = 1:numcircles
    h(n) = fill(ax,x(n)+r(n).*cos(t+rotation(n)), y(n)+r(n).*sin(t+rotation(n)),'',varargin{:});
end
