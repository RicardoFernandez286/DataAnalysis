...
handles.omega1_resolution_text.String = num2str(resW1,'%.3g');
handles.omega3_resolution_text.String = num2str(resW3,'%.3g');

% Display bin zero, phase and FT size
handles.binzero_text.String     = num2str(handles.binzero{m,k});
handles.phase_text.String       = num2str(handles.ZP_phase{m,k}(handles.binspecmax(m,k)),'%.3g');
...
if Action == 1
    ...
    set(handles.plot_Nwhites,'String',plot_Nwhites)
end