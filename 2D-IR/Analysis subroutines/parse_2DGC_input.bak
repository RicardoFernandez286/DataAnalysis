...
for m=1:Npeaks
    ...
    switch isDiagonal(m)
        case 1
            peakfnc{m} = ['G2Dc(X,Y,P(' x0str ')*1000,P(' x0str ')*1000,P(' sxstr '),P(' systr '),C{' peakID '},A{' peakGSB '}) + G2Dc(X,Y,P(' x0str ')*1000,P(' x0str ')*1000-P(' y0str '),P(' sxstr '),P(' s12str '),C{' peakID '},A{' peakESA '})'];
        case 0
            ...
            XpeakGSB_w1 = ['P(' num2str(x0_pos(DiagPkXID(m))) ')*1000'];
            ...
            XpeakGSB_w3_str = ['P(' num2str(x0_pos(DiagPkYID(m))) ')*1000']; % GSB of the cross peak between A and B is at (x_A,y_B)
            XpeakESA_w3_str = [XpeakGSB_w3_str '-P(' num2str(y0_pos(DiagPkYID(m))) ')*1000'];
